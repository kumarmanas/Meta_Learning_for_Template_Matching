...
from model.dataloader.samplers import CategoriesSampler, RandomSampler, ClassSampler, TestCategoriesSampler
...
def get_dataloader(args):
    ...
    val_loader = DataLoader(dataset=valset,
                            ...
                            num_workers=args.num_workers+24,
                            pin_memory=True,persistent_workers= True)
    
    from model.dataloader.scanimage import test_path
    testing_file=test_path
    testset = Dataset(testing_file, args)
    test_sampler = TestCategoriesSampler(testset.label,
                            args.iterations, # args.num_eval_episodes,
                            args.eval_way, args.eval_shot + args.eval_query)
